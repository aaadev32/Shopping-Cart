            ...
            <div id="shop">
                <ol id="shop-items-list">
                    <li className="shop-items">
                        ...
                        <div className="shop-item-price">$14.99</div>
                    ...
                    <li className="shop-items">
                        ...
                        <div className="shop-item-price">$29.99</div>
                        <button onClick={addToCart}>Buy</button>
                    </li>
                    <li className="shop-items">
                    ...
                    <li className="shop-items">
                        ...
                        <div className="shop-item-price">$19.99</div>
                        <button onClick={addToCart}>Buy</button>
                    </li>
                    <li className="shop-items">
                    ...
                    <li className="shop-items">
                        ...
                        <div className="shop-item-price">$39.99</div>
                        <button onClick={addToCart}>Buy</button>
                    </li>
                    <li className="shop-items">
